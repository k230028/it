...
ID 접두사와 최대 번호(양 파일 합산): SEC-24, ERR-17, FE-94, BE-115, CQ-50, LOG-07, BRD-11, EAI-04, REPO-06, MIG-31. 새 ID를 채번한 뒤 `grep -ohE '^\| (SEC|ERR|FE|BE|CQ|LOG|BRD|EAI|REPO|MIG)-[0-9]+' TASK.md TASK_DONE.md | sort | uniq -d`로 중복을 확인합니다.
