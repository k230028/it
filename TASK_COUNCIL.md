...
COUNCIL-047~050은 2026-09-27 심의유형 02 재점검에서 확인한 재진입 경로·위원 재편성·API 유형 경계·겸직 관리자 권한 과제이며, 같은 날 구현·검증을 마쳐 완료 이력으로 옮겼습니다. COUNCIL-050은 사용자 결정에 따라 관리자와 평가위원을 겸해도 관리자 작업을 허용합니다.
COUNCIL-051은 2026-09-27 02 기준 재조사에서 찾은 위원 대상 알림 링크 결함과 프론트 라우팅·카드 라벨 불일치이며, 같은 날 구현·검증을 마쳐 완료 이력으로 옮겼습니다.
COUNCIL-052는 COUNCIL-051 반영 후 02 기준 재점검에서 찾은 사전·주요 Q&A 잔여 API 경계 누락이며, 같은 날 구현·검증을 마쳐 완료 이력으로 옮겼습니다.
