...
**Goal:** `TPRMPP_CBLBMM` 게시판 메타 테이블 기반의 공지사항·자료실 등 재사용 가능한 공통 게시판을 백엔드 API + 프론트엔드 UI로 구현한다.
...
COMMENT ON COLUMN TPRMPP_CBLBMM.BLB_MNG_NO IS '게시판관리번호';
COMMENT ON COLUMN TPRMPP_CBLBMM.BLB_NM     IS '게시판명';
COMMENT ON COLUMN TPRMPP_CBLBMM.BLB_TP     IS '게시판유형';
COMMENT ON COLUMN TPRMPP_CBLBMM.REP_USE_YN IS '답변사용여부';
COMMENT ON COLUMN TPRMPP_CBLBMM.CMMT_USE_YN IS '댓글사용여부';
COMMENT ON COLUMN TPRMPP_CBLBMM.FL_ESN_YN  IS '첨부필수여부';
COMMENT ON COLUMN TPRMPP_CBLBMM.HRK_FXN_USE_YN IS '상위고정사용여부';
COMMENT ON COLUMN TPRMPP_CBLBMM.NAC_TP_USE_YN  IS '게시물유형사용여부';
COMMENT ON COLUMN TPRMPP_CBLBMM.KD_USE_YN      IS '종류사용여부';
COMMENT ON COLUMN TPRMPP_CBLBMM.INQ_ATH_C      IS '조회권한코드';
COMMENT ON COLUMN TPRMPP_CBLBMM.ENR_ATH_C      IS '등록권한코드';
COMMENT ON COLUMN TPRMPP_CBLBMM.BBR_LMTN_USE_YN IS '담당부서한정사용여부';
COMMENT ON COLUMN TPRMPP_CBLBMM.BBR_LMTN_C     IS '담당부서한정코드';
COMMENT ON COLUMN TPRMPP_CBLBMM.SRE_SQN_NO     IS '화면순서번호';
COMMENT ON COLUMN TPRMPP_CBLBMM.USE_YN         IS '사용여부';

-- 2) 게시물 본문 (TPRMPP_CBLBCM)
CREATE TABLE TPRMPP_CBLBCM (
    ...
    CONSTRAINT FK_CBLBCM_BLB FOREIGN KEY (BLB_MNG_NO) REFERENCES TPRMPP_CBLBMM(BLB_MNG_NO)
);
COMMENT ON TABLE  TPRMPP_CBLBCM             IS '게시물';
COMMENT ON COLUMN TPRMPP_CBLBCM.NAC_MNG_NO  IS '게시물관리번호';
COMMENT ON COLUMN TPRMPP_CBLBCM.BLB_MNG_NO  IS '게시판관리번호';
COMMENT ON COLUMN TPRMPP_CBLBCM.NAC_NM      IS '게시물명';
COMMENT ON COLUMN TPRMPP_CBLBCM.NAC_CONE    IS '게시물내용';
COMMENT ON COLUMN TPRMPP_CBLBCM.NAC_INQ_NBR IS '게시물조회수';
COMMENT ON COLUMN TPRMPP_CBLBCM.NAC_TP      IS '게시물유형';
COMMENT ON COLUMN TPRMPP_CBLBCM.KD_C        IS '종류코드';
COMMENT ON COLUMN TPRMPP_CBLBCM.PRIT_C      IS '중요도코드';
COMMENT ON COLUMN TPRMPP_CBLBCM.HRK_FXN_YN  IS '상위고정여부';
COMMENT ON COLUMN TPRMPP_CBLBCM.SRE_YN      IS '화면여부';
COMMENT ON COLUMN TPRMPP_CBLBCM.BBR_C       IS '담당부서코드';
COMMENT ON COLUMN TPRMPP_CBLBCM.STT_YMD     IS '시작일자';
COMMENT ON COLUMN TPRMPP_CBLBCM.END_YMD     IS '종료일자';
COMMENT ON COLUMN TPRMPP_CBLBCM.FL_APG_YN   IS '파일첨부여부';
COMMENT ON COLUMN TPRMPP_CBLBCM.FL_NBR      IS '파일수';
COMMENT ON COLUMN TPRMPP_CBLBCM.NAC_GRP_NO  IS '게시물그룹번호';
COMMENT ON COLUMN TPRMPP_CBLBCM.NAC_GRP_SQN IS '게시물그룹순서';
COMMENT ON COLUMN TPRMPP_CBLBCM.NAC_GRP_LEV IS '게시물그룹레벨';
COMMENT ON COLUMN TPRMPP_CBLBCM.HRK_NAC_MNG_NO IS '상위게시물관리번호';
...
CREATE TABLE TPRMPP_CCMMTM (
    ...
    CONSTRAINT FK_CCMMTM_NAC FOREIGN KEY (NAC_MNG_NO) REFERENCES TPRMPP_CBLBCM(NAC_MNG_NO)
);
COMMENT ON TABLE  TPRMPP_CCMMTM              IS '게시판댓글';
COMMENT ON COLUMN TPRMPP_CCMMTM.CMMT_MNG_NO  IS '댓글관리번호';
COMMENT ON COLUMN TPRMPP_CCMMTM.NAC_MNG_NO   IS '게시물관리번호';
COMMENT ON COLUMN TPRMPP_CCMMTM.CMMT_CONE    IS '댓글내용';
COMMENT ON COLUMN TPRMPP_CCMMTM.SRE_YN       IS '화면여부';
COMMENT ON COLUMN TPRMPP_CCMMTM.CMMT_GRP_NO  IS '댓글그룹번호';
COMMENT ON COLUMN TPRMPP_CCMMTM.CMMT_GRP_SQN IS '댓글그룹순서';
COMMENT ON COLUMN TPRMPP_CCMMTM.CMMT_GRP_LEV IS '댓글그룹레벨';
COMMENT ON COLUMN TPRMPP_CCMMTM.HRK_CMMT_MNG_NO IS '상위댓글관리번호';
...
COMMENT ON TABLE TPRMPP_CBLBML IS '게시판메타변경로그';
...
COMMENT ON TABLE TPRMPP_CCMMTL IS '게시판댓글변경로그';
```
...
-- 변경 로그 시퀀스 (AuditLogIdGenerator 규칙: S_{테이블명_TPRMPP_제거})
...
```sql
-- V20260511_003__common_board_indexes.sql
CREATE INDEX IDX_CBLBCM_LIST   ON TPRMPP_CBLBCM (BLB_MNG_NO, DEL_YN, SRE_YN, HRK_FXN_YN, FST_ENR_DTM);
CREATE INDEX IDX_CBLBCM_GRP    ON TPRMPP_CBLBCM (NAC_GRP_NO, NAC_GRP_SQN);
CREATE INDEX IDX_CBLBCM_HRK    ON TPRMPP_CBLBCM (HRK_NAC_MNG_NO);
CREATE INDEX IDX_CBLBCM_AUTHOR ON TPRMPP_CBLBCM (FST_ENR_USID, DEL_YN);
CREATE INDEX IDX_CBLBCM_BBR    ON TPRMPP_CBLBCM (BBR_C);
CREATE INDEX IDX_CBLBMM_NAV    ON TPRMPP_CBLBMM (USE_YN, SRE_SQN_NO);
CREATE INDEX IDX_CCMMTM_LIST   ON TPRMPP_CCMMTM (NAC_MNG_NO, DEL_YN, SRE_YN, FST_ENR_DTM);
CREATE INDEX IDX_CCMMTM_GRP    ON TPRMPP_CCMMTM (CMMT_GRP_NO, CMMT_GRP_SQN);
CREATE INDEX IDX_CCMMTM_HRK    ON TPRMPP_CCMMTM (HRK_CMMT_MNG_NO);
```
...
-- V20260511_004__common_board_seed.sql
-- 공통코드 시드
INSERT INTO TPRMPP_CCODEM (GRP_C, C, C_NM, SQN_NO, USE_YN, DEL_YN, GUID, GUID_PRG_SNO, FST_ENR_DTM, FST_ENR_USID)
...
# 테이블 존재 확인
SELECT TABLE_NAME FROM USER_TABLES WHERE TABLE_NAME LIKE 'TPRMPP_C%BL%' OR TABLE_NAME LIKE 'TPRMPP_CCMM%';
# 시퀀스 확인
...
| 요구사항 | 구현 태스크 |
|---|---|
| 게시판 메타 관리 (`TPRMPP_CBLBMM`) + 운영자 화면 | Task 1~2, 5, 7~8, 10~11 |
| 게시물 CRUD + 답변글 트리 + Soft Delete | Task 1, 3, 6~8 |
| 댓글 + 대댓글 트리 (`TPRMPP_CCMMTM`) | Task 1, 4, 7~8, 11 |
