...
반입 원본 파일 다이얼로그와 전산업무비·금융정보단말기 첨부 기능([`docs/superpowers/specs/2026-09-09-import-source-and-cost-attachments-design.md`](docs/superpowers/specs/2026-09-09-import-source-and-cost-attachments-design.md)) 최종 리뷰에서 범위 밖으로 분류한 후속 항목입니다. 2026-09-10에 모두 조치했습니다.
